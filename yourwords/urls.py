...
app_name = 'yourwords'
urlpatterns = [
    url(r'^(?P<kind>(read|write))/$', views.index, name='index'),
    ...
    url(r'^set_repeat/(?P<kind>(read|write))/$', views.set_repeat, name='set_repeat'),
    url(r'^set_repeat/$', views.set_repeat, name='set_repeat'),
